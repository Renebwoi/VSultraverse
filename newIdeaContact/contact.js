...
// function myMove() {
//     let id = null;
//     const elem = document.getElementById("stick1");   
//     let deg = 0;
//     clearInterval(id);
...
//       } else {
//         deg++; 
//         elem.style.transform = "rotate(" + deg + "px)"; 
//         // elem.style.left = deg + "px"; 
//       }
//     }
//   }

// Access the div element by its id using jQuery selector
//   var div = $("#stick1");
  // Animate the rotation of the element by 360 degrees over 1 second with a bounce effect
//   div.transition({rotate: "70deg", duration: 1000, easing: "bounce"});